...
const fallbackPageData = {
  ...
  heroStripImage: 'https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=1600&q=80',
...
export default function ProcessAutomationPage() {
  ...
  useEffect(() => {
    const loadPage = async () => {
      try {
        const response = await fetch(`${API_BASE_URL}/api/process-automation-page`)
                ...
                card.variant === 'footer' ? (
                  ...
                  >
                    ...
                    <div className="relative z-[1] flex h-full min-h-[240px] flex-col items-center justify-center p-5 text-center sm:min-h-[280px] sm:p-6">
                      {card.icon === 'megaphone' ? (
                        <IconMegaphone className="h-12 w-12 text-white drop-shadow-md" />
                      ) : (
