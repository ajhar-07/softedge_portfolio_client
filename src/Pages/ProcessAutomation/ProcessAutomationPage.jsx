      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="absolute inset-0 mx-auto flex w-full max-w-7xl items-center px-4 sm:px-6 lg:px-8">
          <ScrollReveal variant="slide-right" duration={0.55}>
            <h1 className="text-5xl font-bold tracking-tight text-white sm:text-6xl">Process Automation</h1>
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[280px_minmax(0,1fr)] lg:px-8 lg:py-14">
        ...
        <main>
          <ScrollReveal variant="fade-up" className="space-y-6">
            <div className="relative isolate h-[240px] overflow-hidden border border-white/10 sm:h-[280px]">
              <img
              ...
              <p className="absolute right-4 top-4 text-3xl font-black uppercase tracking-[0.2em] text-white/95 sm:right-6 sm:text-4xl">
                Automation
              </p>
            </div>

            <div>
              <h2 className="text-4xl font-bold text-white">Process Automation</h2>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <article className="group relative isolate min-h-[280px] overflow-hidden border border-white/10">
                <img
                  src={CARD_DEV_IMAGE}
                  alt="Web development"
                ...
                <div className="relative z-[1] flex h-full min-h-[280px] flex-col items-center justify-center p-6 text-center">
              ...
              <article className="relative isolate flex min-h-[280px] flex-col overflow-hidden border border-white/10">
                <img
